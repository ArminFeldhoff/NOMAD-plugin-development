...
```sh
git clone https://github.com/ArminFeldhoff/nomad_test_schema.git
cd nomad_test_schema
...
| Name | E-mail     |
|------|------------|
| Armin Feldhoff | [armin.feldhoff@pci.uni-hannover.de](mailto:armin.feldhoff@pci.uni-hannover.de)
